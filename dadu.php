...
echo  "\ e [95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬▬▬▬▬▬▬▬▬▬ \ n " ;
echo  "\ e [96m _________________ PERINGATAN !!!!!!!! _________________ \ n" ;
echo  "\ e [96m INI SCRIB GOJEK INI GRATIS BRO \ n" ;
echo  "\ e [96m JADI GUNAKANLAH DENGAN BIJAK \ n" ;
echo  "\ e [96 m SCRIB INI TIDAK DI JUAL BELIKAN \ n" ;
echo  "\ e [96m SUBCRIBE CHANNEL YOUTUTBE: \ n" ;
echo  "\ e [96m RAMZ TUTORIAL \ n" ;
echo  "\ e [96 m BIAR BISA MAKIN SEMANGAT BIKIN KONTENNYA \ n" ;
echo  "\ e [96m * SUROBOYO LOSS PUNTEN GOPUD \ n" ;
gema  "\ e [96m ******** \ e [95m" . tanggal ( '[dmY] [H: i: s]' ). "\ e [96m ******** \ n" ;
echo  "\ e [95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬▬▬▬▬▬▬▬▬▬ \ n " ;
echo  "\ e [96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
echo  "\ e [93m \ e [96m YOK SAATNYA KITA MULAI \ e [93m \ n" ;
echo  "\ e [96m ============================================ == \ n " ;
echo  "\ e [96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
echo  "\ e [95m ID Pengguna Sudah Punya (Y / T?:" ;	
$ pilihy = trim ( fgets ( STDIN ));
if ( $ pilihy == "y" || $ pilihy == "sudah" )
echo  "\ e [96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
	login goto;
Gabung:
echo  "\ e [96 m▬▬▬ SEGERA KLIK ENTER DI BAWAH INI ▬▬▬▬▬ \ n" ;
$ pass = ( '║ Login Pengguna:' );
gema  "\ 033 [30; 40m" ;
...
lain
{
		echo  "\ e [96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;	
		echo  "\ e [91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
		echo  "\ e [96m [🚫] \ e [91mBISMILLAH DULU SEBELUM CLAIM \ e [96m [🚫] \ n" ;
	        echo  "\ e [96m [🚫] \ e [91mKLIK ENTER AJA \ e [96m [🚫] \ n" ;
		echo  "\ e [96m [🚫] \ e [91mJIKA GAGAL BERARTI GA TULUS \ e [96m [🚫] \ n" ;
	        echo  "\ e [96m [🚫] \ e [91mDAN NASIB ANDA KURANG BERUNTUNG WKWK \ e [96m [🚫] \ n" ;
		echo  "\ e [91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
login goto;
}
...
ulang:
gema  "\ n" ;
echo  "\ e [96m (HONGKONG SINGAPORE POLL $ input) \ n" ;
echo  "\ e [89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
// perubahan fungsi () {
        $ nama = nama ();
        $ email = str_replace ( "" , "" , $ nama ). mt_rand ( 100 , 999 );
         warna gema ( "kuning" , "📲 ▶ ️ Nomor:" );
        // $ no = trim (fgets (STDIN));
        ...
        $ otptoken = getStr ( '"otp_token": "' , '"' , $ register );
         warna gema ( "hijau" , "📶 ▶ ️ OTP DIKIRIM TUH" ). "\ n" ;
        otp:
        ...
        echo color("nevy","\n▬▬▬▬▬▬▬▬▬▬▬▬* SANTUY DULU KAWAN *▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","# CLAIM TOGEL HONGKONG ");
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("nevy","# CLAIM TOGEL SINGAPORE");
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","🔓▶️ Message: ".$message);
        echo "\n".color("nevy","# CLAIM TOGEL SIDNEY");
        echo "\n".color("yellow","# NUNGGUIN YAA :V  , SING PENTING TOMBOK");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(5);
        }
